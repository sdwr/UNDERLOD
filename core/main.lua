...
require 'level_classes/objects'
require 'level_classes/miscellaneous_objects'
require 'core/media'
...
function update(dt)
  ...
  if input['f8'].pressed then
    DEBUG_PLAYER_TROOPS = not DEBUG_PLAYER_TROOPS
    print('DEBUG_PLAYER_TROOPS:', DEBUG_PLAYER_TROOPS)
    print('DEBUG_PLAYER_CHARACTER_TYPE:', DEBUG_PLAYER_CHARACTER_TYPE)
  end
