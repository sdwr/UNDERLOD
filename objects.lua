...
function Unit:show_damage_number(dmg, damagetype)
  if show_damage_numbers == 'none' then return end
  if show_damage_numbers == 'enemies' and not table.any(main.current.enemies, function(enemy) return enemy.class == self.class end) then return end
  if show_damage_numbers == 'friendlies' and not table.any(main.current.units, function(unit) return unit.class == self.class end) then return end
