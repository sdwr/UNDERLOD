...
function Arena:draw()
  ...
  self.main:draw_all_except_tags({'projectile', 'enemy_projectile'})
  ...
  Profiler:start("projectiles_draw")
  self.main:draw_objects_by_tags({'projectile', 'enemy_projectile'})
  Profiler:finish("projectiles_draw")
