...
PERK_DEFINITIONS = {
  ...
  enemy_flat_def = {
    name = "Enemy Defense",
    description = "-10/20/30 enemy defense",
    icon = "enemy_damage",
    rarity = "common",
    stats1 = {enemy_flat_def = -10},
    stats2 = {enemy_flat_def = -20},
    stats3 = {enemy_flat_def = -30},
  },
  enemy_percent_def = {
    name = "Enemy Defense",
    description = "Enemies have 20%/30%/40% lower defense",
    icon = "enemy_damage",
    rarity = "common",
    stats1 = {enemy_percent_def = -0.2},
    stats2 = {enemy_percent_def = -0.3},
    stats3 = {enemy_percent_def = -0.4},
  },
  enemy_knockback_damage = {
    name = "Enemy Knockback",
    description = "+30%/45%/60% enemy knockback",
    icon = "enemy_knockback_damage",
    rarity = "common",
    stats1 = {enemy_knockback_resistance = -0.3},
