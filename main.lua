...
function init()
  ...
  character_descriptions = {
    ...
    ['pyro'] = function(lvl) return '[fg]uses a flamethrower [yellow]' .. get_character_stat('pyro', lvl, 'dmg') .. '[fg] damage and pierces' end,
    ['burst'] = function(lvl) return '[fg]casts burst missile [yellow' .. get_character_stat('burst', lvl, 'dmg') .. '[fg] damage each' end,
  ...
  character_stats = {
    ...
    ['burst'] = function(lvl) return get_character_stat_string('burst', lvl) end, 
  ...
  unit_stat_multipliers = {
    ...
    ['burst'] = {hp = 1, dmg = 1, def = 1, mvspd = 1},
  ...
  class_descriptions = {
    ...
    ['cursed'] = function(lvl) return '[' .. ylb1(lvl) .. ']2[light_bg]/[' .. ylb2(lvl) .. ']4 [fg]- [' .. ylb1(lvl) .. ']+1[light_bg]/[' .. ylb2(lvl) .. ']+3 [fg]max curse targets to allied cursers' end,
  ...
  tier_to_characters = {
    ...
    [2] = {'shaman', 'paladin', 'priest', 'cannon', 'burst', 'bomber'},
  ...
  first_run_tier_to_characters = {
    ...
    [2] = {'shaman', 'cannon', 'laser', 'burst', 'bomber'},
    [3] = {'sniper'},
    [4] = {'sniper'}
  }
