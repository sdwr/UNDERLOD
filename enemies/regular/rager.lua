Rager = Object:extend()
Rager:implement(GameObject)
Rager:implement(Physics)
Rager:implement(Unit)
Rager:implement(Enemy)
function Rager:init(args)
...
function Rager:attack(area, mods, color)
    mods = mods or {}
