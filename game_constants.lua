...
LAUNCH_PUSH_FORCE_ENEMY = 40
LAUNCH_PUSH_FORCE_BOSS = 70

KNOCKBACK_DURATION_BOSS = 0.6
KNOCKBACK_DURATION_ENEMY = 0.35
...
STARTING_WAVE_TEXT_DURATION = 1
STARTING_WAVE_COUNTDOWN_DURATION = 0.7
TOTAL_STARTING_WAVE_DELAY = STARTING_WAVE_TEXT_DURATION + (3 * STARTING_WAVE_COUNTDOWN_DURATION)
