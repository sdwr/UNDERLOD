...
ENEMY_KNOCKBACK_FORCE_TROOP_COLLISION = 300
...
MOVEMENT_TYPE_ENTER_ARENA = 'enter_arena'
MOVEMENT_TYPES = {MOVEMENT_TYPE_SEEK, MOVEMENT_TYPE_LOOSE_SEEK, MOVEMENT_TYPE_SEEK_TO_RANGE, MOVEMENT_TYPE_RANDOM, MOVEMENT_TYPE_FLEE, MOVEMENT_TYPE_NONE, MOVEMENT_TYPE_ENTER_ARENA}
